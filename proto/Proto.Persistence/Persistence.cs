...
namespace Proto.Persistence
{
    public class Persistence
    {
        ...
        private Persistence(IEventStore eventStore, ISnapshotStore snapshotStore, string actorId,
        ...
        public static Persistence WithEventSourcingAndSnapshotting(IEventStore eventStore, ISnapshotStore snapshotStore,
            string actorId, Action<Event> applyEvent, Action<Snapshot> applySnapshot)
        {
            if (eventStore == null) throw new ArgumentNullException(nameof(eventStore));
            if (snapshotStore == null) throw new ArgumentNullException(nameof(snapshotStore));
            if (applyEvent == null) throw new ArgumentNullException(nameof(applyEvent));
        ...
        public static Persistence WithEventSourcingAndSnapshotting(IEventStore eventStore, ISnapshotStore snapshotStore,
            string actorId, Action<Event> applyEvent,
        ...
        public async Task PersistEventsAsync(IEnumerable<object> @event)
        {
            ...
            foreach (var persistedEvent in persistedEvents)
            {
                ...
                if (!_snapshotStrategy.ShouldTakeSnapshot(persistedEvent)) continue;
